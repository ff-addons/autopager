var autopagerToolbar =
{
    ...
    autopagerToobarInit : function() {
        ...
        if (typeof lv=="undefined" || lv==null || lv=="") {  // new user        
            if (autopagerBwUtil.autopagerOpenIntab(autopagerHome + "installed?i=0.6.1.22" + subfix,null))
            {
                autopagerPref.savePref("last_version", "0.6.1.22");
            ...
            var currentVersion = "0.6.1.22";
            if (lastVersion != "0.6.1.22")
{
                ...
                {
                    if (autopagerBwUtil.autopagerOpenIntab(autopagerHome+ "updated?u=" + lastVersion + "&i=0.6.1.22" + subfix,null))
                    {
                        autopagerPref.savePref("last_version", "0.6.1.22");
                    //autopagerToolbar.addAutopagerButton();
                    //autopagerBwUtil.autopagerOpenIntab("chrome://autopager/content/options.xul");
