...
pref("autopager.discoverytext", "navbar|right_arrow");
...
pref("autopager.loading", "position: fixed; z-index: 2147483647; font-size: 75%; bottom: 1px; right: 20px;padding: 1px; background: green none repeat scroll 0%; display:none;");
pref("autopager.optionstyle", "line-height:normal;width:190px;position: fixed; z-index: 2147483647; font-size: 75%; bottom: 1px; right: 20px;padding: 1px; background: green none repeat scroll 0%; display:none;");
